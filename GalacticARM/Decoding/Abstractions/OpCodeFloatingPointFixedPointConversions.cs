...
{
    class OpCodeFloatingPointFixedPointConversions : AOpCode 
    {
        ...
        {
            OpCodeFloatingPointFixedPointConversions Out = new OpCodeFloatingPointFixedPointConversions();
