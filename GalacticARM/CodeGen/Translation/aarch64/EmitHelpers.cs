    ...
    public unsafe partial class Emit64
    {
        ...
        public static Operand Shift(TranslationContext context, ShiftType Type, Operand Source, Operand Imm)
        {
            ...
            switch (Type)
            {
                ...
                case ShiftType.ROR: return context.Or(context.ShiftRight(Source, Imm),context.ShiftLeft(Source, context.Subtract(context.Const(context.CurrentSize == IntSize.Int32 ? 32 : 64), Imm)));
